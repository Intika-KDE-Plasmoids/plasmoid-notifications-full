...
Column {
    ...
    function addNotification(notification) {
        ...
        for (var i = 0; i < notificationsModel.count; ++i) {
				if (notificationsModel.get(i).appName == notification.appName) {
					if (
					notificationsModel.get(i).appName.toLowerCase() == "spotify"
					|| notificationsModel.get(i).appName.toLowerCase() == "clementine"
					|| notificationsModel.get(i).appName.toLowerCase() == "amarok"
					|| notificationsModel.get(i).appName.toLowerCase() == "rhythmbox"
					|| notificationsModel.get(i).appName.toLowerCase() == "audacious"
					|| notificationsModel.get(i).appName.toLowerCase() == "qmmp"
					|| notificationsModel.get(i).appName.toLowerCase() == "cmus"
					|| notificationsModel.get(i).appName.toLowerCase() == "vlc"
					|| notificationsModel.get(i).appName.toLowerCase() == "deadbeef"
					|| notificationsModel.get(i).appName.toLowerCase() == "gnome-music"
					|| notificationsModel.get(i).appName.toLowerCase() == "lollypop"
					|| notificationsModel.get(i).appName.toLowerCase() == "gmusicbrowser"
					|| notificationsModel.get(i).appName.toLowerCase() == "quod-libet"
					|| notificationsModel.get(i).appName.toLowerCase() == "cantata"
					|| notificationsModel.get(i).appName.toLowerCase() == "musique"
					|| notificationsModel.get(i).appName.toLowerCase() == "tomahawk"
					|| notificationsModel.get(i).appName.toLowerCase() == "moc"
					|| notificationsModel.get(i).appName.toLowerCase() == "guayadeque"
					|| notificationsModel.get(i).appName.toLowerCase() == "exaile"
					|| notificationsModel.get(i).appName.toLowerCase() == "mopidy"
					|| notificationsModel.get(i).appName.toLowerCase() == "banshee"
					|| notificationsModel.get(i).appName.toLowerCase() == "htingale"
					|| notificationsModel.get(i).appName.toLowerCase() == "juk"
					|| notificationsModel.get(i).appName.toLowerCase() == "mplayer"
					|| notificationsModel.get(i).appName.toLowerCase() == "nuvolaplayer"
					|| notificationsModel.get(i).appName.toLowerCase() == "xmms"
					|| notificationsModel.get(i).appName.toLowerCase() == "aqualung"
					|| notificationsModel.get(i).appName.toLowerCase() == "spotify"
					|| notificationsModel.get(i).appName.toLowerCase() == "yarock"
					|| notificationsModel.get(i).appName.toLowerCase() == "ocenaudio"
					|| notificationsModel.get(i).appName.toLowerCase() == "deepin-music"
					)
					{
